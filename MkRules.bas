...
'USE IF ONE SUBJECT
Call SetRulesSubjectFolder("TANDEM", "APPLIS", "TANDEM", "TANDEM", "info@macro.fr", "info2@macro.fr")

'DO NOT CHANGE CODES
AFTER'///////////////////////////////////////////////////////////////////////////////////////////
End Sub

Sub SetRulesSubjectFolder(strRule As String, strFolder As String, strFolder2 As String, strSubj
As String, strEmail1 As String, strEmail2 As String)
...
Set oMoveTarget = Application.Session.GetDefaultFolder(olFolderInbox).Folders.item(strFolder).
Folders.item(strFolder2)
...
Sub SetRulesSubjectFolder2Subjects(strRule As String, strFolder As String, strFolder2 As
String, strSubj As String, strSubj2 As String, strEmail1 As String, strEmail2 As String)
Dim colRules As Outlook.Rules
Dim oRule As Outlook.rule
Dim colRuleActions As Outlook.RuleActions
Dim oMoveRuleAction As Outlook.MoveOrCopyRuleAction
